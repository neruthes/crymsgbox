...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Display mailboxes
    var meTabContent = document.getElementById('tab3mailboxes');
    mailboxes.forEach(function (mailbox, index) {
        ...
        button.addEventListener('click', function () {
            navigator.clipboard.writeText(pubkeyBase32).then(function () {
                alert('Copied Pubkey.');
            });
        });
    ...
    copyButton.addEventListener('click', function () {
        navigator.clipboard.writeText(currentCiphertext).then(function () {
